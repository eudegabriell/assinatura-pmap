...
export default function Setttings() {
  ...
  return (
    <div>
      <Head>
        <title>Configurações | Assinatura PMAP</title>
      </Head>
      <header className="py-10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h1 className="text-brown text-3xl font-bold leading-tight tracking-tight">Configurações</h1>
        </div>
      </header>
      <div
        ...
        <div className="overflow-hidden rounded-lg bg-white shadow">
          <div className="divide-y divide-gray-200 lg:grid lg:grid-cols-12 lg:divide-y-0 lg:divide-x">
              ...
              <div className="py-6 px-4 sm:p-6 lg:pb-8">
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Preencha seu nome para facilitar a identificação.
                  </p>
                </div>
            ...
            <div
              ...
              <div className="py-6 px-4 sm:p-6 lg:pb-8">
                <div>
                  <h2 className="text-lg font-medium leading-6 text-gray-900">Atualizar senha</h2>
            ...
            <div
              ...
              <div className="py-6 px-4 sm:p-6 lg:pb-8">
                <div>
                  <h2 className="text-lg font-medium leading-6 text-gray-900">Cobrança</h2>

                  {!isSubscriptionsEnabled() && (
                    <p className="mt-2 text-sm text-gray-500">
                      As assinaturas não estão habilitadas nesta instância, você não precisa fazer nada aqui.
                    </p>
                  )}
                    ...
                    <>
                      ...
                      {subscription?.status === SubscriptionStatus.PAST_DUE && (
                        <p className="mt-1 text-sm text-red-500">
                          Sua assinatura está vencida. Atualize seus detalhes de pagamento para
                          continue usando o serviço sem interrupção.
                        </p>
                      )}
