      ...
      <div className="bg-neon p-4">
        <div className="flex">
          <div className="flex-shrink-0 flex gap-x-2 items-center">
            ...
            <h2 className="text-2xl font-semibold">Assinatura PMAP</h2>
          </div>
          ...
          <div className="mx-3 flex-1 items-center justify-start text-center md:flex md:justify-between">
            <p className="text-lg text-slate-700">
              ...
              pediu que você assinasse este documento.
            </p>
          ...
          <div className="flex">
            ...
            <div className="ml-3 flex-1 md:flex md:justify-between">
              <p className="text-sm text-yellow-700">
                Você pode assinar este documento em qualquer lugar que desejar, mas talvez procure uma linha de assinatura.
              </p>
            </div>
          </div>
        </div>
